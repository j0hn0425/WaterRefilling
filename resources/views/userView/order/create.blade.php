		...
		<div class="container p-3 my-3 border">
			...
			<form action="/order" method="POST">
				...
				<div class="row mb-3">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" readonly="true" name="prod_name" value="{{$product->Product_name}}">
					</div>
				</div>
				<div class="row mb-3">
					<label for="inputQuantity" class="col-sm-2 col-form-label">Prize</label>
					<div class="col-sm-10">
