		...
		<div class="container p-3 my-3 border">
			...
			<form action="/manageOrder/{{$manageOrder->Order_id}}" method="POST">
				...
				<div class="row mb-3">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" readonly="true" value="{{$manageOrder->Quantity}}" name="Prodprize">
					</div>
				</div>
				<div class="row mb-3">
				...
				<div class="row mb-3">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" readonly="true" value="{{$manageOrder->Amount}}" name="rate">
					</div>
				</div>
				<div class="row mb-3">
					<label for="inputDescription" class="col-sm-2 col-form-label">Date</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" readonly="true" value="{{$manageOrder->created_at}}" name="rate">
					</div>
				</div>
				<div class="row mb-3">
